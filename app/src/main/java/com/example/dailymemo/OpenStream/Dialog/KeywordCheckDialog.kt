...
import com.example.dailymemo.databinding.DialogKeywordCheckBinding
...
class KeywordCheckDialog(context: Context) : Dialog(context) {
    lateinit var binding: DialogKeywordCheckBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DialogKeywordCheckBinding.inflate(LayoutInflater.from(context))

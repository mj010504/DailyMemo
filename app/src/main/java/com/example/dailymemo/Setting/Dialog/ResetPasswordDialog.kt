...
import com.example.dailymemo.databinding.DialogResetPasswordBinding
...
class ResetPasswordDialog(context: Context) : Dialog(context) {
    lateinit var binding: DialogResetPasswordBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DialogResetPasswordBinding.inflate(LayoutInflater.from(context))

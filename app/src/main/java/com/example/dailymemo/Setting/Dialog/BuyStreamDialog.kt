...
class BuyStreamDialog(context: Context) : Dialog(context) {
    lateinit var binding: DialogBuyStreamBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DialogBuyStreamBinding.inflate(LayoutInflater.from(context))

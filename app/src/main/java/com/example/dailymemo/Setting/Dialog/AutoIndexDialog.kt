...
class AutoIndexDialog(context: Context) : Dialog(context) {
    lateinit var binding: DialogAutoIndexBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DialogAutoIndexBinding.inflate(LayoutInflater.from(context))
        setContentView(binding.root)

        resize(this, 0.9f, 0.5f )
